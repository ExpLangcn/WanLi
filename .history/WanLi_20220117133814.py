...
class newcmd(cmd.Cmd):
    ...
    fofa_parser.add_argument("keyword", help='Fofa查询默认查询10000条，并自动导出 fofa app="thinkphp"')
    fofa_parser.add_argument("-g", help="FoFa 搜索语法帮助表 fofa -g")
    fofa_parser.add_argument("-t", help="FoFa 搜索关键字提示下拉列表 fofa -t thinkphp")
    fofa_parser.add_argument("-f", help="FoFa 批量查询规则文件 fofa -f keyword.txt")
