...
def f_fofascan(target):
    if config.config.email == '':
        ...
        Key = getpass.getpass("Key：")
        datatime = datetime.now().strftime('%Y-%m-%d-%H-%M-%S')
        system(config.config.fofa + r" -m " + str(Email) + r" -k " + str(Key) + r" -f " + str(target) + r" -o logs/FOFA_" + datatime + r"_" + str(target) +r".txt")
    else:
        datatime = datetime.now().strftime('%Y-%m-%d-%H-%M-%S')
...
def ih_fofascan(target):
    if config.config.email == '':
        ...
        Key = getpass.getpass("Key：")
        datatime = datetime.now().strftime('%Y-%m-%d-%H-%M-%S')
        system(config.config.fofa + r" -m " + str(Email) + r" -k " + str(Key) + r" -ih " + str(target) + r" -o logs/FOFA_" + datatime + r"_" + str(target) +r".txt")
    else:
        datatime = datetime.now().strftime('%Y-%m-%d-%H-%M-%S')
