...
def ddir(domain):
    ...
    system(config.config.PYTHON + " " + config.config.dirsearch +r" -l " + "logs/" + datatime + r"_domain_output.txt -r -t 150 --recursion-status=200,301,302 --exclude-sizes=3KB -q --format csv -o logs/" + datatime + r"_ddir_output.csv")
