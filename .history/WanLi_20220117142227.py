...
class newcmd(cmd.Cmd):
    ...
    quake_parser.add_argument(
        "-h", nargs='?', help='Fofa查询默认查询10000条，并自动导出 \033[1;37;34mfofa app="thinkphp"\033[0m')
    quake_parser.add_argument(
        "-s", nargs='?', help='Fofa查询默认查询10000条，并自动导出 \033[1;37;34mfofa app="thinkphp"\033[0m')
    quake_parser.add_argument(
        "-t", nargs='?', help='Fofa查询默认查询10000条，并自动导出 \033[1;37;34mfofa app="thinkphp"\033[0m')
    quake_parser.add_argument(
        "-f", nargs='?', help='Fofa查询默认查询10000条，并自动导出 \033[1;37;34mfofa app="thinkphp"\033[0m')
    quake_parser.add_argument(
        "-m", nargs='?', help='Fofa查询默认查询10000条，并自动导出 \033[1;37;34mfofa app="thinkphp"\033[0m')
