...
class newcmd(cmd.Cmd):
    ...
    fofa_parser.add_argument("-f", help="FoFa 搜索关键字提示下拉列表 fofa -t thinkphp")
    fofa_parser.add_argument("-ih", help="FoFa 搜索指定Url的 favicon icon_hash fofa -ih https://www.default.com/favicon.ico")
    # fofa搜索
