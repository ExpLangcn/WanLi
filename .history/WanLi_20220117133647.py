...
class newcmd(cmd.Cmd):
    ...
    fofa_parser.add_argument("-g", help="FoFa 搜索语法帮助表 fofa -g thinkphp")
    fofa_parser.add_argument("-t", help="FoFa 搜索关键字提示下拉列表 fofa -t fofa thinkphp")
    fofa_parser.add_argument("-ih", help="FoFa 搜索指定Url的 favicon icon_hash")
    # fofa搜索
